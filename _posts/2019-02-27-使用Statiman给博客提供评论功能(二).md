...
后来，我自己搜到了另一个公有的Staticman实例，是由[vincenttam](https://vincenttam.gitlab.io)提供的，万分感谢。vincenttam是StaticmanLab的维护者，使用Staticman给GitLab提供静态评论功能（其实就是Staticman的V3版本）。他提供的staticman的实例api是https://staticman3.herokuapp.com  ，对应的GitHub合作者是[staticmanlab](https://github.com/staticmanlab)。
